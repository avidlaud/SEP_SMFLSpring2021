...
INSTALL
	...
	Additionally, the AI bot runs in Python 3 and has additional dependencies:
		pip install pandas
...
RUN
	...
	In a separate terminal, open the app/service/ai directory
	Run "node index"
		This will locally run the ai service backend
